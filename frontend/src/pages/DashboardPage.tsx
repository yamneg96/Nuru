...
const LEARNING_CARDS = [
  {
    ...
    desc: "A simple guide to healthy communication and boundaries in relationships.",
    badge: "3 min read",
    cta: "Read Article",
  ...
  },
  {
    ...
    desc: "An overview of different methods available to you and how they work.",
    badge: "5 min video",
    cta: "Watch Video",
  ...
  },
  {
    ...
    desc: "Take a moment to assess your emotional well-being today.",
    badge: "Interactive",
    cta: "Start Check-in",
