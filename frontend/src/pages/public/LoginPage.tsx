          ...
          <div className="relative flex flex-col gap-8 overflow-hidden rounded-[2rem] border border-outline-variant/30 bg-surface-container-lowest p-8 shadow-sm shadow-primary/5 md:p-12">
            ...
            <div className="relative z-10 flex flex-col gap-4">
              ...
              <button
                ...
                className="flex flex-wrap w-full items-center justify-center gap-2 rounded-full bg-transparent px-6 py-4 text-primary transition-colors duration-200 hover:bg-surface-container-low active:scale-[0.98]"
              >
