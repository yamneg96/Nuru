...
export function ContactPage() {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-background pb-20">
      ...
      <main className="w-full max-w-360 mx-auto pb-24">
        {/* Hero Section */}
        <section className="relative bg-linear-to-br from-surface-container-high to-surface-container-low px-5 md:px-8 py-12 md:py-20 overflow-hidden mb-12 rounded-b-3xl md:rounded-bl-[3rem] md:rounded-br-none">
          ...
          <div className="relative z-10 max-w-4xl">
            ...
            <h1 className="font-['Plus_Jakarta_Sans'] text-3xl md:text-[30px] leading-9.5 font-bold text-primary-fixed-dim mb-4">
              {t('contact.hero_title', 'Get Help Safely with Nuru')}
            </h1>
            <p className="font-['Inter'] text-lg text-on-surface-variant max-w-2xl mb-8">
              {t('contact.hero_desc', "Talk, learn, and connect through safe and trusted channels. We're here to support you without judgment.")}
            </p>
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <a href="tel:994" className="bg-surface text-primary font-['Inter'] font-semibold px-8 py-4 rounded-full flex items-center gap-2 hover:bg-surface-container transition-all active:scale-[0.98] border border-outline-variant">
                ...
                {t('contact.call_hotline', 'Call Hotline')}
              </a>
            </div>
          </div>
          
          {/* Hero Illustration */}
          <div className="hidden lg:block absolute right-12 bottom-0 w-100 h-75 pointer-events-none">
          ...
          <section>
            <div className="mb-8">
              <h2 className="font-['Plus_Jakarta_Sans'] text-2xl font-semibold text-on-surface flex items-center gap-3">
                ...
                {t('contact.instant_help', 'Instant Help')}
              </h2>
              <p className="font-['Inter'] text-base text-on-surface-variant mt-2">{t('contact.instant_help_desc', 'Automated, secure, and private assistance available 24/7.')}</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-surface rounded-2xl p-6 border border-outline-variant shadow-[0_10px_40px_-10px_rgba(0,88,190,0.08)] hover:-translate-y-1 transition-transform duration-300 relative overflow-hidden group">
                ...
                <div className="relative z-10 flex flex-col h-full">
                  ...
                  <p className="font-['Inter'] text-base text-on-surface-variant mb-8 grow">Chat anonymously with our smart assistant. Get quick answers on reproductive health, local clinics, and more.</p>
              ...
              <div className="bg-surface rounded-2xl p-6 border border-outline-variant shadow-[0_10px_40px_-10px_rgba(0,88,190,0.08)] hover:-translate-y-1 transition-transform duration-300 relative overflow-hidden group">
                ...
                <div className="relative z-10 flex flex-col h-full">
                  ...
                  <p className="font-['Inter'] text-base text-on-surface-variant mb-8 grow">Connect securely on WhatsApp. Our bot uses end-to-end encryption to ensure your queries remain private.</p>
                  <div className="flex flex-wrap items-center justify-between mt-auto gap-2">
                    <span className="font-['Inter'] text-xs font-semibold uppercase text-on-surface-variant bg-surface-container px-3 py-1 rounded-full flex items-center gap-1">
                      <span className="w-2 h-2 rounded-full bg-secondary"></span> 24/7 Available
                    </span>
          ...
          <section>
            <div className="mb-8">
              <h2 className="font-['Plus_Jakarta_Sans'] text-2xl font-semibold text-on-surface flex items-center gap-3">
                ...
                {t('contact.human_support', 'Human Support')}
              </h2>
              <p className="font-['Inter'] text-base text-on-surface-variant mt-2">{t('contact.human_support_desc', 'Sometimes you just need to talk to a real person.')}</p>
            </div>
            
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              {/* Nuru Support Team */}
              <div className="lg:col-span-2 bg-linear-to-r from-primary-fixed to-surface-container rounded-3xl p-8 border border-outline-variant flex flex-col md:flex-row items-start md:items-center justify-between gap-8 shadow-[0_10px_40px_-10px_rgba(0,88,190,0.08)]">
                <div className="">
                  <div className="flex items-center gap-2 mb-4">
                    <span className="w-3 h-3 rounded-full bg-primary animate-pulse"></span>
                    <span className="font-['Inter'] text-xs font-semibold uppercase tracking-widest text-on-primary-fixed">{t('contact.live_now', 'Live Now')}</span>
                  </div>
                  <h3 className="font-['Plus_Jakarta_Sans'] text-2xl font-bold text-on-primary-fixed mb-2">{t('contact.support_team', 'Nuru Support Team')}</h3>
                  <p className="font-['Inter'] text-base text-on-surface mb-6">{t('contact.support_team_desc', "Our trained support staff are online and ready to listen. We provide a safe space to discuss anything that's on your mind.")}</p>
                  <div className="flex flex-wrap gap-4">
                    <a href="tel:8222" className="bg-primary text-on-primary font-['Inter'] font-semibold px-6 py-3 rounded-full flex items-center gap-2 hover:bg-surface-tint transition-all">
                      ...
                      {t('contact.call_now', 'Call Now (Free)')}
                    </a>
                    <button onClick={() => navigate("/appointments")} className="bg-surface text-primary border border-primary font-['Inter'] font-semibold px-6 py-3 rounded-full flex items-center gap-2 hover:bg-surface-container transition-all">
                      ...
                      {t('contact.book_session', 'Book Session')}
                    </button>
                  </div>
                </div>
                <div className="w-full md:w-auto shrink-0 flex -space-x-4">
              ...
              <div className="bg-surface rounded-3xl p-8 border border-outline-variant flex flex-col justify-center">
                ...
                <h3 className="font-['Plus_Jakarta_Sans'] text-xl font-semibold text-on-surface mb-2">{t('contact.youth_peers', 'Youth Peers')}</h3>
                <p className="font-['Inter'] text-sm text-on-surface-variant mb-6">{t('contact.youth_peers_desc', "Talk to trained peers who understand what you're going through.")}</p>
                <button onClick={() => navigate("/appointments?type=peer")} className="w-full bg-surface text-primary border border-outline-variant font-['Inter'] font-semibold py-3 rounded-full hover:bg-surface-container transition-colors flex items-center justify-center gap-2 mt-auto">
                  ...
                  {t('contact.request_peer', 'Request Peer Match')}
                </button>
              </div>
            </div>
          </section>
          ...
          <section className="bg-surface rounded-3xl p-8 border border-outline-variant shadow-sm max-w-3xl mx-auto">
            <div className="mb-8 text-center">
              ...
              <p className="text-on-surface-variant">
                {t('contact.send_message_desc', 'Have a specific question or issue? Fill out the form below and our team will get back to you.')}
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <label htmlFor="name" className="block text-sm font-medium text-on-surface mb-1">{t('contact.name_optional', 'Name (Optional)')}</label>
                  <input
                    type="text"
                    id="name"
                    name="name"
                ...
                <div>
                  <label htmlFor="email" className="block text-sm font-medium text-on-surface mb-1">{t('contact.email_optional', 'Email (Optional)')}</label>
                  <input
                    type="email"
                    id="email"
                    name="email"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="md:col-span-1">
                  <label htmlFor="category" className="block text-sm font-medium text-on-surface mb-1">{t('contact.category', 'Category')}</label>
                ...
                <div className="md:col-span-1">
                  <label htmlFor="subject" className="block text-sm font-medium text-on-surface mb-1">{t('contact.subject', 'Subject')}</label>
                  <input
                    type="text"
                    id="subject"
                    name="subject"
              ...
              <div>
                <label htmlFor="message" className="block text-sm font-medium text-on-surface mb-1">{t('contact.message_label', 'Message')}</label>
                <textarea
                  id="message"
                  name="message"
      ...
      <footer className="fixed bottom-0 w-full bg-error-container/90 backdrop-blur-md border-t border-error-container z-50">
        <div className="max-w-360 mx-auto px-6 py-4 flex items-start sm:items-center gap-4">
